...
eaten_chuncks = Dessert("eaten chuncks",1,99)
print(food_orders_app.add_meals_to_menu(eaten_chuncks,str))
print(food_orders_app.show_menu())
print(food_orders_app.add_meals_to_shopping_cart("0000000000",**{"eaten chuncks":98}))
print(food_orders_app.add_meals_to_shopping_cart("0000000000",**{"eaten chuncks":0}))
print(food_orders_app.menu[-1].quantity)
print(food_orders_app.cancel_order("0000000000"))
print(food_orders_app.menu[-1].quantity)
